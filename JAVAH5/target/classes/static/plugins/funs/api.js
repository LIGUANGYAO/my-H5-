define([], function() {
	...
	//图表数据
	exportsObj.getPresentWeightRecord = baseUrl + '/weUserWeightList';
	...
	//反馈信息提交
    exportsObj.saveWxbUserProposal = baseUrl + '/weight/scale/saveWxbUserProposal.do';
	 ...
	 */
    //pk榜列表接口
	exportsObj.showRankData = baseUrl + '/weight/scale/showRankDataCount.do';
