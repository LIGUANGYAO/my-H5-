define(['jquery', 'count'], function($, Count) {
    ...
    exportsObj.linkTo = function(url, par) {
        ...
        URL = URL.replace('&v=10.0', '')
        window.location.href = URL + '&v=10.0'
    }
    //跳转
    ...
    exportsObj.showToastr = function(text, timeout) {
        ...
        $('.toastr').remove();
        var elm = $('<div class="toastr" style="position: fixed; top: 0px; left: 0px; text-align: center; right: 0px; color: rgb(255, 255, 255); display: table; vertical-align: middle; height: 100%; width: 100%;"><div class="wrap" style="    display: table-cell;    vertical-align: middle;"><div class="text" style="    background: rgba(0,0,0,.8);    display: inline-block;    padding: .25rem .35rem;    border-radius: .2rem;">123</div></div></div>');
