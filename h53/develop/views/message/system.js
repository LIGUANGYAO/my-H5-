                                ...
                                success:function(res){
                                    if(res.result.data){
                                        if(res.result.data[0]!==undefined){
                                            ...
                                            _this.sysreply = res.result.data[0];
                                            $(".feedback").on('click',function(){
                                                common.linkTo2("./feedback.html")
                                            })
                                        }else{
                                            $(".feedback").on('click',function(){
                                                common.linkTo2("./empty.html",null,"titleName=意见反馈");
                                            })
                                        }
                                    }
                                }
                            ...
                            $.ajax({
                                ...
                                success: function(res) {
                                    ...
                                    if(res.result.data){
                                        ...
                                        _this.reporrtList = res.result.data[0];
                                        ...
                                        $(".healtRport").on("click",function(){
                                            common.linkTo2("./empty.html",null,"titleName=健康报表");
                                        })
                                    }
