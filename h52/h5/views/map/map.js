...
require(['jquery', 'Vue', 'common','Swiper','api','async!amap'], function($, Vue, common,Swiper,api) {
	$(function() {				        
				...
				methods: {
					...
					_closeDotModal: function() {
						...
						map.on('click', function() {
					        ...
					        markerImg.src = '../../assets/images/map/dot_blue.png';
								...
								if (data.length>0) {	  																																																					closeLoading();					
									...
									that.initData.forEach(function(marker, index) {										
								        markers = new AMap.Marker({
									        ...
									        icon: new AMap.Icon({            									            
									            image: '../../assets/images/map/dot_blue.png',
							...
							$.ajax({
								...
								success: function(data) {
                                        ...
                                        for (var i = 0; i < that.nearby.dotData.length > 0; i++) {
                                           ...
                                           that.nearby.dotData[i].address = that.nearby.dotData[i].address;
					...
					openNearbyOutletsDetails: function(e) {
						...
						window.location.href = 'details.html' + common.jsonToQueryString(params);
					},
					//打开附近网点列表
