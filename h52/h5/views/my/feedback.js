                ...
                methods: {
                    ...
                    saveJianyi: function() {
                        ...
                        if (this.file.size > (10 * 1024 * 1024)) {
                          return common.showToastr('图片不能大于5M');
                        } 
                        ...
                        UploadFile(this.file, function(base64, blob){
                            _this.disableJianyi = true;

                            if (base64) {
                                form.append("picFile", blob, "file_"+Date.parse(new Date())+".jpg"); // 文件对象
                            }
                            else {
                                form.append('picFile', _this.file)
                            }
                            $.ajax({
                                type: 'POST',
                    ...
                    saveTucao: function() {
                        ...
                        if (this.file2.size > (10 * 1024 * 1024)) {
                          return common.showToastr('图片不能大于10M');
                        } 
                        var _this = this;

                        UploadFile(this.file2, function(base64, blob){
                            _this.disableJianyi = true;
                            ...
                            if (base64) {
                                ...
                                form.append('picFile', _this.file2)
                            }

                            _this.disableTucao = true;
                            $.ajax({
                                type: 'POST',
                                url: api.saveFeedback,
                                dataType: 'json',
