        ...
        setTimeout(function() {
            new Vue({
                ...
                mounted: function() {
                    ...
                    _this.today = today;
                    _this.selectedDay = today.substr(5)
                    ...
                    $(document).on('click', '.card-list .item', function() {
                        $(this).addClass('checked').siblings().removeClass('checked') 
                    })

                    $(document).on('click', '.calendar .day', function() {

                        var day = $(this).data('day').replace(/\//g, '-');


                        _this.selectedDay = day.substr(5);
                        _this.getDaySign(day, function() {
                            _this.isSelectToday = _this.today == day
                        })
                    })
                    ...
                    this.getProfile(function() {
                        _this.getManage(function() {
                            ...
                            if (_this.today >= _this.manageData.vo.endDate) {
                                _this.showModifyDlg = true;
                                _this.overStage = true;
                            }
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                for(var i = 0; i < res.length; i++) {
                                    ...
                                    item.createTime = item.createTime.toString().substr(8,2) + ':' + item.createTime.toString().substr(10,2) 
                                }
                            }
                        })
                    },
...
setTimeout(function() {
                    ...
                    setCalendar: function() {
                        ...
                        $('.calendar .today span').text('今')
                         ...
                         var isNew = $('.calendar .datepicker-days tbody tr:last td:first').hasClass('new');
                         if (isNew)
                          $('.calendar  .datepicker-days tbody tr:last').remove()
                    },
                    ...
                    addSign: function() {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                weight: $('.card-list .item.checked .a3 .b1').attr('value')
